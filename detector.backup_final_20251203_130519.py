...
class SAM3Detector:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # FIX 1: Bajar aún más el threshold para detectar más objetos en condiciones reales
        # Default is 0.5, but we use 0.02 to catch even more objects including small/dark/occluded/overlapping ones
        # Lower threshold helps detect small objects, dark objects, partially occluded objects, and overlapping objects
        self.processor = Sam3Processor(
            self.model, 
            device=actual_device,
            confidence_threshold=0.02  # FIX 1: REDUCED from 0.05 to 0.02 for more detections in real-world conditions
        )
