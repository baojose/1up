...
class SAM3Detector:
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Default is 0.5, but we use 0.05 to catch more objects including small/dark/occluded/overlapping ones (can be filtered later)
        # Lower threshold helps detect small objects, dark objects, partially occluded objects, and overlapping objects
        self.processor = Sam3Processor(
            self.model, 
            device=actual_device,
            confidence_threshold=0.05  # Very low threshold to detect small objects, dark objects, partially occluded objects, and overlapping objects
        )
